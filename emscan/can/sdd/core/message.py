...
class Message:
    ...
    def _coloring(self, msg:MessageObj) -> List[str]:
    ...
    def addMessageHeading(self, msg:MessageObj):
        self.addHeading(f"{msg.ID}: {msg.name}", level=2, fontSize=14, alignCenter=False)
        return

    def addMessageSpec(self, msg:MessageObj):
        specs = {
            "ECU": "SENDER",
            "ID": "ID",
            "Message": "MESSAGE",
    ...
    def addMessageLayout(self, msg:MessageObj):
    ...
    def addSignalList(self, msg:MessageObj):
        specs = {
            "Signal": "Signal",
    ...
    def addSignalProperty(self, msg:MessageObj):
        specs = {
            "Signal": "Signal",
