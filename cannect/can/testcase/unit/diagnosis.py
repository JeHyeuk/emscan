...
def diagnosis_alive(message:str, variables:List[str]=None, **override) -> UnitTestCase:
    """
    ...
    if variables is None:
        ...
        ks = KeywordSearch(*variables)
        ks.warning = True
        dd.alive_valid          = ks[nm.aliveCountValid]
        dd.diagnosis_enable     = ks[nm.diagnosisEnable]
        dd.debounce_threshold   = ks[nm.debounceTime]
        dd.debounce_timer       = ks[nm.debounceTimerAlv]
        dd.diagnosis_bit        = ks[nm.diagnosisAlv]
        dd.deve                 = ks[nm.deveAlv]
...
def diagnosis_crc(message:str, variables:List[str]=None, **override) -> UnitTestCase:
    """
    ...
    if variables is None:
        ...
        ks = KeywordSearch(*variables)
        ks.warning = True
        dd.crc_valid            = ks[nm.crcValid]
        dd.diagnosis_enable     = ks[nm.diagnosisEnable]
        dd.debounce_threshold   = ks[nm.debounceTime]
        dd.debounce_timer       = ks[nm.debounceTimerCrc]
        dd.diagnosis_bit        = ks[nm.diagnosisCrc]
        dd.deve                 = ks[nm.deveCrc]
...
def fid_inhibit(message:str, variables:List[str]=None, **override) -> UnitTestCase:
    """
    ...
    if variables is None:
        ...
        dd.fid                  = ks[nm.fid]
        dd.debounce_threshold   = ks[nm.debounceTime]
        dd.debounce_timer_msg   = ks[nm.debounceTimerMsg]
        dd.debounce_timer_alv   = ks[nm.debounceTimerAlv]
        dd.debounce_timer_crc   = ks[nm.debounceTimerCrc]
...
def error_clear(message:str, variables:List[str]=None, **override) -> UnitTestCase:
    """
    ...
    if variables is None:
        ...
        ks = KeywordSearch(*variables)
        ks.warning = True
        dd.eep_reset            = ks[nm.eepReset]
        dd.eep                  = ks[nm.eep]
        dd.diagnosis_bit_msg    = ks[nm.diagnosisMsg]
        dd.diagnosis_bit_alv    = ks[nm.diagnosisCrc]
        dd.diagnosis_bit_crc    = ks[nm.diagnosisAlv]
        dd.deve_msg             = ks[nm.deveMsg]
        dd.deve_alv             = ks[nm.deveAlv]
        dd.deve_crc             = ks[nm.deveCrc]
...
def clear_edr(message:str, variables:List[str]=None, **override) -> UnitTestCase:
    """
